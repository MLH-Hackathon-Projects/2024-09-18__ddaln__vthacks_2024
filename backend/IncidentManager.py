...
def insert_data_from_txt(description: str):
    speech_to_text_dict = convert_response_to_dict(description)
...
returned_value = recognize_from_microphone()

speech_to_text_dict = convert_response_to_dict(returned_value)
